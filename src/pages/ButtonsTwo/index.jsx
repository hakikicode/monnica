...
import ButtonsTwoColumnlabel from "components/ButtonsTwoColumnlabel";
import ButtonsTwoProperty1open from "components/ButtonsTwoProperty1open";

const ButtonsTwoPage = () => {
  return (
    <>
