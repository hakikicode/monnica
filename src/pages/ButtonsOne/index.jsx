...
import ButtonsOneColumnlabel from "components/ButtonsOneColumnlabel";
import ButtonsOneProperty1open from "components/ButtonsOneProperty1open";

const ButtonsOnePage = () => {
  return (
    <>
